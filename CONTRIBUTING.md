# Contributing to reactjs-redux-seed

Love reactjs-redux-seed and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/leduong/reactjs-redux-seed/issues) is
...
1.  [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
    ...
    git clone https://github.com/<your-username>/reactjs-redux-seed.git
    # Navigate to the newly cloned directory
    cd reactjs-redux-seed
    # Assign the original repo to a remote called "upstream"
    git remote add upstream https://github.com/leduong/reactjs-redux-seed.git
    ```
...
owners to license your work under the terms of the [MIT License](https://github.com/leduong/reactjs-redux-seed/blob/master/LICENSE.md).

# Collaborating guidelines

There are few basic rules to ensure high quality of the `reactjs-redux-seed`:
